...
@Database(entities = {UsersTable.class, MessagesTable.class, GroupsTable.class, GroupMessagesTable.class,ContactTable.class, ChatsTable.class}, version = 1, exportSchema = false)
